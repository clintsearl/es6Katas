  ...
  describe('Iterator usages', () => {
    ...
    beforeEach(function(){
      ...
      function iteratorFunction() {
        return {
          next: function() {
            //statement to say when there are none left done is the opposite !....
            const anyLeft = consumableUsers.anyLeft
            return {value: consumableUsers.nextUser, done:!anyLeft}
          }
        }
      }
      //had some help from github on this one. Not sure I understand what's going on
      //going to look back over symbol and the basics of iterators some more.
      usersIterable = {
    ...
    describe('fill the iterable with content using `ConsumableUsers`', function() {
      ...
      describe('using built-in constructs', function() {
        ...
        it('use for-of to loop over an iterable', function() {
          // need to use ... spread operator for it to bring them all in
        ...
        it('destructure an iterable like an array', function() {
          //Removed the {} because it asks to destructure like an array[]
